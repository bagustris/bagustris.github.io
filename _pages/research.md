...
4. Development of Calfem-Python
5. Development of Vibration Toolbox
6. Indonesian emotional speech synthesis using FastSpeech
7. COVID-19 diagnosis using SPEECH sound with deep learning, dataset: ComParE CSS 2021
8. Predicting pathological voice disorders with speech processing techniques, dataset: SVD, Voiced, HUPA
9. Detection of emotion intensity in non-speech sounds (laughter, crying, etc.)
10. Detecting/predicting stuttering (bahasa: gagap) in speech with machine learning
11. Predicting the intensities of seven self-reported emotions (Adoration, Amusement, Anxiety, Disgust, Empathic Pain, Fear, Surprise) from user-generated reactions to emotionally evocative videos
12. Few-shot learning on acoustic data to capture 10 dimensions of emotions reliably perceived in distinct vocal bursts: Awe, Excitement, Amusement, Awkwardness, Fear, Horror, Distress, Triumph, Sadness, and Surprise
13. Multimodal learning (audio+video+text) to capture 10 dimensions of emotions reliably perceived in distinct vocal bursts: Awe, Excitement, Amusement, Awkwardness, Fear, Horror, Distress, Triumph, Sadness, and Surprise
14. Inferring self-reported emotions from multimodal expression, using multi-output regression to predict fine-grained self-report annotations of seven 'in-the-wild' emotional experiences
